...
const Masterizacion = (props) => {
  return (
    <>
      <div className="masterizacion-container">
        <Head>
          <title>Masterizacion - Basic Productions</title>
          <meta
            property="og:title"
            content="Masterizacion - Basic Productions"
          />
        </Head>
        <div className="masterizacion-container1 mainContainer">
          <TopImageRow rootClassName="top-image-row-root-class-name7"></TopImageRow>
          <div className="masterizacion-container2 content">
            <h1 className="PageHeading masterizacion-text">MASTERIZACIÓN</h1>
            <div className="masterizacion-features">
              <span className="masterizacion-text01">
                <span>
              ...
              <div className="masterizacion-container3">
                <FeatureCard
            ...
            <div className="masterizacion-steps">
              <h1 className="masterizacion-text07">¿Como Funciona?</h1>
              <div className="masterizacion-container4">
                <div className="masterizacion-container5">
                  <div className="step">
                    <h1 className="masterizacion-text08">
                      <span>1</span>
                    </h1>
                    <h1 className="masterizacion-text10">Envío</h1>
                    <span className="masterizacion-text11">
                      <span>
                  ...
                  <div className="step masterizacion-step1">
                    <h1 className="masterizacion-text14">
                      <span>2</span>
                    </h1>
                    <h1 className="masterizacion-text16">Análisis</h1>
                    <span className="masterizacion-text17">
                      <span>
                ...
                <div className="masterizacion-container6">
                  <div className="step masterizacion-step2">
                    <h1 className="masterizacion-text20">
                      <span>3</span>
                    </h1>
                    <h1 className="masterizacion-text22">Masterización</h1>
                    <span className="masterizacion-text23">
                      <span>
                  ...
                  <div className="step masterizacion-step3">
                    <h1 className="masterizacion-text26">
                      <span>4</span>
                    </h1>
                    <h1 className="masterizacion-text28">
                      <span>Escucha</span>
                      <br></br>
                    </h1>
                    <span className="masterizacion-text31">
                      <span>
      ...
      <style jsx>
        {`
          ...
          .masterizacion-container1 {
            gap: var(--dl-space-space-twounits);
            height: fit-content;
          }
          .masterizacion-container2 {
            gap: 0;
            flex-wrap: wrap;
            flex-direction: column;
            padding-bottom: 0px;
          ...
          .masterizacion-text01 {
            text-align: justify;
          }
          .masterizacion-container3 {
            width: 100%;
            display: grid;
          ...
          .masterizacion-text07 {
            color: var(--dl-color-gray-black);
            font-size: 2.5rem;
            margin-bottom: var(--dl-space-space-unit);
          }
          .masterizacion-container4 {
            display: flex;
            align-items: flex-start;
            flex-direction: row;
          }
          .masterizacion-container5 {
            width: 50%;
            display: flex;
            align-items: flex-start;
            flex-direction: row;
          }
          .masterizacion-text08 {
          ...
          .masterizacion-text10 {
            font-size: 1.15rem;
            font-weight: 500;
          }
          .masterizacion-text11 {
            color: var(--dl-color-gray-500);
            font-size: 0.75rem;
            margin-top: var(--dl-space-space-oneandhalfunits);
            text-align: justify;
          }
          .masterizacion-text14 {
            color: var(--dl-color-gray-900);
            font-size: 4rem;
            text-align: center;
            font-weight: 900;
          ...
          .masterizacion-text16 {
            font-size: 1.15rem;
            font-weight: 500;
          }
          .masterizacion-text17 {
            color: var(--dl-color-gray-500);
            font-size: 0.75rem;
            margin-top: var(--dl-space-space-oneandhalfunits);
            text-align: justify;
          }
          .masterizacion-container6 {
            width: 50%;
            display: flex;
            align-items: flex-start;
            flex-direction: row;
          }
          .masterizacion-text20 {
            color: var(--dl-color-gray-900);
            font-size: 4rem;
            text-align: center;
            font-weight: 900;
          ...
          .masterizacion-text22 {
            font-size: 1.15rem;
            font-weight: 500;
          }
          .masterizacion-text23 {
            color: var(--dl-color-gray-500);
            font-size: 0.75rem;
            margin-top: var(--dl-space-space-oneandhalfunits);
            text-align: justify;
          }
          .masterizacion-text26 {
            color: var(--dl-color-gray-900);
            font-size: 4rem;
            text-align: center;
            font-weight: 900;
          ...
          .masterizacion-text28 {
            font-size: 1.15rem;
            font-weight: 500;
          }
          .masterizacion-text31 {
            color: var(--dl-color-gray-500);
            font-size: 0.75rem;
            margin-top: var(--dl-space-space-oneandhalfunits);
            text-align: justify;
